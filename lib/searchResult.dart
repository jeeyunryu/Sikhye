...
Future<Autogenerated> fetchProducts(String text) async {
  // String product = '새우깡';

  final response = await http.get(Uri.parse(
      'https://openapi.foodsafetykorea.go.kr/api/2d72697d0d2747119655/C002/json/1/10/PRDLST_NM=\'$text\''));
...
class _ProductsWidgetState extends State<ProductsWidget> {
  ...
  void initState() {
    super.initState();
    futureProducts = fetchProducts(widget.text);
  }
